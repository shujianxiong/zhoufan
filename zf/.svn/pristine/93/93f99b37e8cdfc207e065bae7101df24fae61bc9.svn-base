...
<head>
    ...
    <style id="printCss" type="text/css">
       ...
       .sfReceiveInfo {
           font-family: SimHei, Arial, "Microsoft YaHei";
           font-size: 10pt;
           font-weight: bold;
       }
       .sfSendInfo {
...
<%--                 <shiro:hasPermission name="bus:ol:sendOrder:edit">
    ...
    <script type="text/javascript">
        ...
        function printForm(){
	        ...
	        //插入背景图
            // a>  打印本地图片
            LODOP.ADD_PRINT_IMAGE(0,0,"100mm","150mm","<img border='0' src='C:/background.jpg'/>");
            LODOP.SET_PRINT_STYLEA(0,"Stretch",1);//按原图比例(不变形)缩放模式
            // b>  打印web图片
            //var strBASE64Code=document.getElementById('t1').value;


            LODOP.ADD_PRINT_HTM(54, 282, "27mm","6mm", "<div style='font-size: 12pt; font-family: SimHei, \"Microsoft YaHei\";'>标准快递</div>");

            LODOP.ADD_PRINT_BARCODE(68,19,"60mm","12mm","128A", "${sendOrder.expressNo}");


            LODOP.ADD_PRINT_HTM(128,45,"85mm","12mm",strBodyStyle+"<div class='sfDestcode'>${sendOrder.destCode}</div>");

            LODOP.ADD_PRINT_HTM(180,45,"85mm","12mm",strBodyStyle+"<div class=\"sfReceiveInfo\">${sendOrder.receiveName }&nbsp;&nbsp;&nbsp;&nbsp;${sendOrder.receiveTel }<br/>${sendOrder.receiveAreaStr}${sendOrder.receiveAreaDetail }</div>");


            LODOP.ADD_PRINT_HTM(228,45,"50mm","6mm",strBodyStyle+"<div class=\"sfSendInfo\">${fns:getSysConfig('expressReceiverName').configValue}&nbsp;&nbsp;&nbsp;&nbsp;${fns:getSysConfig('expressReceiverPhone').configValue}<br/>${fns:getSysConfig('expressReceiverAddress').configValue}</div>");



            LODOP.ADD_PRINT_BARCODE(351,118,"45mm","10mm","128A", "${sendOrder.expressNo}");


            LODOP.ADD_PRINT_HTM(402,44,"85mm","7mm",strBodyStyle+"<div class='printDiv littlteSendAddre'>${fns:getSysConfig('expressReceiverName').configValue}&nbsp;&nbsp;&nbsp;&nbsp;${fns:getSysConfig('expressReceiverPhone').configValue}<br/>${fns:getSysConfig('expressReceiverAddress').configValue}</div>");
            LODOP.ADD_PRINT_HTM(440,44,"85mm","7mm",strBodyStyle+"<div class='printDiv littlteReceiveAddre'>${sendOrder.receiveName }&nbsp;&nbsp;&nbsp;&nbsp;${sendOrder.receiveTel }<br/>${sendOrder.receiveAreaStr}${sendOrder.receiveAreaDetail }</div>");


            LODOP.ADD_PRINT_HTM(268, 10, "70mm","6mm", strBodyStyle+"<div class='sfPayInfo'>付款方式：&nbsp;寄方付&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;计费重量：</br>月结账号：&nbsp;5717082692&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;费用合计：</div>");
